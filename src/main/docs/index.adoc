...
When looking at the bytecode generated from each of the three compiler options, there are some common themes.
Particularly when looking at method execution.
